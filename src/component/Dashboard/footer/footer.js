    ...
    return(
        <div className="footer">
              ...
              <div className="footer-main">
                ...
                <div>
                    <h4>Contact us</h4>
                    <a href="/home"><img src={insta} className='footerimg' ></img></a>
                    <a href="/home"><img src={whatsapp}  className='footerimg'></img></a>
                    <a href="/home"><img src={pintrest} className='footerimg' ></img></a>
                    <a href="/home"><img src={linkedin} className='footerimg' ></img></a>
                    <a href="/home"><img src={youtube} className='footerimg' ></img></a>
                </div>
